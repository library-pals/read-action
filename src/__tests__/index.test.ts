  ...
  test("works, started a new book", async () => {
    ...
    expect(exportVariableSpy.mock.calls).toMatchInlineSnapshot(`
      [
        ...
        [
          "BookThumb",
          "https://books.google.com/books?id=NFeTEAAAQBAJ&printsec=frontcover&img=1&zoom=6&edge=curl&source=gbs_api",
        ],
      ]
    `);
    ...
    expect(setOutputSpy.mock.calls[0]).toMatchInlineSnapshot(`
      [
        "nowReading",
        {
          ...
          "isbn": "9780385696005",
          "thumbnail": "https://books.google.com/books?id=NFeTEAAAQBAJ&printsec=frontcover&img=1&zoom=6&edge=curl&source=gbs_api",
          "title": "Luster",
        },
      ]
    `);
  ...
  test("works, finished a book (new, not started)", async () => {
    ...
    expect(exportVariableSpy.mock.calls).toMatchInlineSnapshot(`
      [
        ...
        [
          "BookThumb",
          "https://books.google.com/books?id=5LhBEAAAQBAJ&printsec=frontcover&img=1&zoom=6&edge=curl&source=gbs_api",
        ],
      ]
    `);
    expect(setFailedSpy).not.toHaveBeenCalled();
      ...
      [
        ...
        [
          ...
          },
          {
            ...
            "printType": "BOOK",
            "status": "finished",
            "thumbnail": "https://books.google.com/books?id=5LhBEAAAQBAJ&printsec=frontcover&img=1&zoom=6&edge=curl&source=gbs_api",
